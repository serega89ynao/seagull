...
<div class="col-12"> 
	<div class="row">
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'article-single entry-article'); ?>>
			<header class="entry-header">
				...
				if( has_post_thumbnail() ) {
					...
					<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/default-img.jpg" alt="<?php esc_html__('no-image', 'seagull');?>">
				<?php } ?>
			</header><!-- .entry-header -->
